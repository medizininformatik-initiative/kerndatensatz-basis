# MII EXA Fall Kontakt Gesundheitseinrichtung (Abteilungskontakt Innere Medizin) - MII Implementation Guide Core Dataset Base v2026.0.0

## Example Encounter: MII EXA Fall Kontakt Gesundheitseinrichtung (Abteilungskontakt Innere Medizin)
...
**identifier**: Visit number/F_20200108_001_INME
...
**period**: 2020-01-12 00:00:00+0100 --> 2020-01-17 18:00:00+0100

> **diagnosis****condition**: [Condition Sonstige näher bezeichnete Krankheiten des Innenohres](Condition-mii-exa-diagnose-condition-multiple-codings.md)**use**: Chief complaint

> **diagnosis****condition**: [Condition Sonstige näher bezeichnete Krankheiten des Innenohres](Condition-mii-exa-diagnose-condition-multiple-codings.md)**use**: Admission diagnosis

> **diagnosis****condition**: [Condition Gonokokkeninfektion des Muskel-Skelett-Systems](Condition-mii-exa-diagnose-mehrfachcodierung-primaercode.md)**use**: Behandlungsrelevante Diagnosen
...
**partOf**: [Encounter: identifier = Visit number; status = finished; class = inpatient encounter (v3 Code System ActCode#IMP); type = Einrichtungskontakt; period = 2020-01-08 07:00:00+0100 --> 2020-01-17 18:00:00+0100](Encounter-mii-exa-fall-kontakt-gesundheitseinrichtung-1.md)
