...
Simple Extension with the type dateTime: The planned start date/time (or admission date) of the encounter
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-ex-fall-planned-start-date.csv), [Excel](../StructureDefinition-mii-ex-fall-planned-start-date.xlsx), [Schematron](../StructureDefinition-mii-ex-fall-planned-start-date.sch) 
...
```json
{
  ...
  "status" : "active",
  "date" : "2025-12-12T17:10:58+00:00",
    ...
    "element" : [
      {
        "id" : "Extension",
        "path" : "Extension",
        "short" : "MII EX Fall Planned Start Date",
