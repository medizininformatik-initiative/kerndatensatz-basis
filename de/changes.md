...
* **Changed**: Kardinalität von `Encounter.period` im [Encounter](StructureDefinition-mii-pr-fall-kontaktgesundheitseinrichtung.md)-Profil von 1..1 auf 0..1, um geplante Behandlungsfälle darzustellen, bei denen der tatsächliche Zeitraum noch unbekannt ist. Siehe: https://github.com/medizininformatik-initiative/kerndatensatzmodul-fall/issues/56
