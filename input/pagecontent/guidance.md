...
For conformance requirements and must support definitions, see the [Conformance](conformance.html) section.

For technical artifacts including profiles, extensions, and terminology, see the [FHIR Artifacts](artifacts.html) section.