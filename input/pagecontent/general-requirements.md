...
There are situations when information on a particular data element is missing, and the source system does not know the reason for the absence of data. See the [Missing Data](missing-data.html) page for detailed guidance on how to handle missing data in MII profiles.
...
* [Must Support](must-support.html) - Detailed Must Support requirements
* [General Requirements](general-requirements.html) - Additional general requirements
* [Missing Data](missing-data.html) - Guidance for handling missing data
* [Capability Statements](capability-statements.html) - Server and Client capability requirements