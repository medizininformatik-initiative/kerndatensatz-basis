...
* Einrichtungskontakt.Beginndatum 0..* http://hl7.org/fhir/StructureDefinition/dateTime "Start des Kontakt Zeitraums"
* Einrichtungskontakt.Enddatum 0..* http://hl7.org/fhir/StructureDefinition/dateTime "Ende des Kontakt Zeitraums"
* Einrichtungskontakt.Entlassungsgrund 0..* http://hl7.org/fhir/StructureDefinition/code "Gemäß §21 KHEntgG" "Gemäß §21 KHEntgG"
* Abteilungskontakt 0..* BackboneElement "Kontakte zur Abteilung"
...
* Abteilungskontakt.KontaktArt 0..* http://hl7.org/fhir/StructureDefinition/CodeableConcept "Differenzierung zwischen verschiedenen Arten von Kontakten (z.B. vorstationär, nachstationär, intensivstationär)."
...
* Abteilungskontakt.Beginndatum 0..* http://hl7.org/fhir/StructureDefinition/dateTime "Start des Kontakt Zeitraums"
* Abteilungskontakt.Enddatum 0..* http://hl7.org/fhir/StructureDefinition/dateTime "Ende des Kontakt Zeitraums"
...
* Versorgungsstellenkontakt 0..* BackboneElement "Kontakte zu Versorgungsstellen und den eigentlich Behandelnden"
...
* Versorgungsstellenkontakt.KontaktArt 0..* http://hl7.org/fhir/StructureDefinition/CodeableConcept "Differenzierung zwischen verschiedenen Arten von Kontakten (z.B. vorstationär, nachstationär, intensivstationär)."
* Versorgungsstellenkontakt.PatientenIdentifikator 0..* http://hl7.org/fhir/StructureDefinition/Identifier "Bei der internen Nutzung dient die sogenannte Patientennummer als Identifikator. Diese wird bei der ersten Aufnahme in die Einrichtung parallel zur ersten Fallnummer (Aufnahmenummer) vergeben. Bei jeder Wiederaufnahme (oder korrigierend danach) erfolgt eine Zuordnung zu dieser konstanten Patientennummer und die Vergabe einer neuen wechselnden Fallnummer."
* Versorgungsstellenkontakt.Aufnahmenummer 0..* http://hl7.org/fhir/StructureDefinition/Identifier "Jeder Patient erhält bei der Planung einer Aufnahme oder bei der Aufnahme selbst eine Aufnahmenummer (auch Fallnummer oder Krankenhausinternes Kennzeichen genannt). Im Prinzip gilt diese Aufnahmenummer von der Aufnahme bis zur Entlassung - und auch bei den zugehörigen vorstationären und nachstationären Kontakten. Sie dient bei allen digital unterstüzten Vorgängen der Zuordnung zu dem Aufenthalt des Patienten in der Einrichtung. Im MII KDS dient sie als Identifikator bzw. Referenz zum Einrichtungskontakt."
* Versorgungsstellenkontakt.Beginndatum 0..* http://hl7.org/fhir/StructureDefinition/dateTime "Start des Kontakt Zeitraums"
* Versorgungsstellenkontakt.Enddatum 0..* http://hl7.org/fhir/StructureDefinition/dateTime "Ende des Kontakt Zeitraums"

Mapping: Fall-LogicalModel
Id: FHIR
Title: "Fall LogicalModel FHIR Mapping"
Source: MII_LM_Fall
Target: "http://hl7.org/fhir/StructureDefinition/Encounter|4.0.1"
* Einrichtungskontakt.KontaktEbene -> "Encounter.type"
* Einrichtungskontakt.KontaktArt -> "Encounter.type"
* Einrichtungskontakt.PatientenIdentifikator -> "Encounter.subject"
* Einrichtungskontakt.Aufnahmenummer -> "Encounter.identifier"
* Einrichtungskontakt.Aufnahmeanlass -> "Encounter.hospitalization.admitSource"
* Einrichtungskontakt.Aufnahmegrund -> "Encounter.extension('http://fhir.de/StructureDefinition/Aufnahmegrund')"
* Einrichtungskontakt.Beginndatum -> "Encounter.period.start"
* Einrichtungskontakt.Enddatum -> "Encounter.period.end"
* Einrichtungskontakt.Entlassungsgrund -> "Encounter.hospitalization.dischargeDisposition"
* Abteilungskontakt.KontaktEbene -> "Encounter.type"
* Abteilungskontakt.KontaktArt -> "Encounter.type"
* Abteilungskontakt.PatientenIdentifikator -> "Encounter.subject"
* Abteilungskontakt.Aufnahmenummer -> "Encounter.identifier"
* Abteilungskontakt.Beginndatum -> "Encounter.period.start"
* Abteilungskontakt.Enddatum -> "Encounter.period.end"
* Versorgungsstellenkontakt.KontaktEbene -> "Encounter.type"
* Versorgungsstellenkontakt.KontaktArt -> "Encounter.type"
* Versorgungsstellenkontakt.PatientenIdentifikator -> "Encounter.subject"
* Versorgungsstellenkontakt.Aufnahmenummer -> "Encounter.identifier"
* Versorgungsstellenkontakt.Beginndatum -> "Encounter.period.start"
* Versorgungsstellenkontakt.Enddatum -> "Encounter.period.end"