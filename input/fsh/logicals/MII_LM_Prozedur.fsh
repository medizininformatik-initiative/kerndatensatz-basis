...
* DetaillierteAnatomischeStruktur 0..* Reference(BodyStructure) "Detaillierte anatomische Struktur" "Detaillierte Angaben zu der patientenbezogenen anatomischen Struktur oder Lokalisation, auf die sich die Prozedur bezieht. Das Element kann verwendet werden, wenn die kodierte Angabe der Körperstelle allein nicht die für den Anwendungsfall erforderliche Genauigkeit bietet."
...
* DetaillierteAnatomischeStruktur -> "Procedure.bodySite.extension('http://hl7.org/fhir/StructureDefinition/bodySite').valueReference"
