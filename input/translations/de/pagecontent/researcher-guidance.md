...
Die [Logischen Modelle](logical-models.html) bieten technologieunabhängige Beschreibungen der in jedem Modul enthaltenen Daten:
...
Die [UML-Diagramme](uml-diagrams.html) zeigen, wie verschiedene Datenelemente innerhalb und zwischen Modulen miteinander in Beziehung stehen. Diese Diagramme sind besonders nützlich für:
...
Der Abschnitt [Beispiele](examples.html) bietet praxisnahe Beispiele von FHIR-Ressourcen, die zeigen:
