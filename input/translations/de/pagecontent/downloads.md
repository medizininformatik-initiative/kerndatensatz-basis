...
- [MII Kerndatensatz Basis ImplementationGuide-Ressource](ImplementationGuide-mii-ig-basis.html)

#### Versionshistorie

Frühere Versionen dieses Implementierungsleitfadens und eine detaillierte Änderungshistorie finden Sie auf der Seite [Versionshistorie](version-history.html).
