...
* Wenn Informationen zu einem bestimmten Datenelement fehlen und der MII-Server den genauen Grund für das Fehlen der Daten kennt, **SOLLEN** MII-Server den Grund für die fehlenden Informationen gemäß den Leitlinien im Abschnitt [Fehlende Daten](missing-data.html) senden
