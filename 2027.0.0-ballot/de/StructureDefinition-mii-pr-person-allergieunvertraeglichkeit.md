# MII PR Person Allergy Intolerance - MII Implementation Guide Core Dataset Base v2027.0.0-ballot

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Person Allergy Intolerance**

## Ressourcenprofil: MII PR Person Allergy Intolerance 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-person/StructureDefinition/AllergieUnvertraeglichkeit | *Version*:2027.0.0-ballot |
| Active Stand: 2026-09-04 | *Maschinenlesbarer Name*:MII_PR_Person_AllergieUnvertraeglichkeit |

 
Eine dokumentierte Allergie oder Unverträglichkeit der Patientin oder des Patienten. 

Das MII-Profil Allergie / Unverträglichkeit ist eine neue Ergänzung des Moduls Person und strebt eine abgestimmte Abbildung patientenbezogener Allergien und Unverträglichkeiten an mit:
...
* und [HL7 Europe Base 2.0.0](https://hl7.eu/fhir/base/2.0.0/StructureDefinition-allergyIntolerance-eu-core.html)
...
Diese Struktur ist abgeleitet von [AllergyIntolerance](http://hl7.org/fhir/R4/allergyintolerance.html) 
...
* [http://hl7.org/fhir/StructureDefinition/allergyintolerance-abatement](http://hl7.org/fhir/extensions/5.3.0/StructureDefinition-allergyintolerance-abatement.html)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-person-allergieunvertraeglichkeit.csv), [Excel](../StructureDefinition-mii-pr-person-allergieunvertraeglichkeit.xlsx), [Schematron](../StructureDefinition-mii-pr-person-allergieunvertraeglichkeit.sch) 
