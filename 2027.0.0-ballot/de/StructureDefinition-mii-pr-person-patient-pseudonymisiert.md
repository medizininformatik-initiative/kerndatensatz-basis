# MII PR Person Patient (Pseudonymisiert) - MII Implementation Guide Core Dataset Base v2027.0.0-ballot
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/core/modul-person/StructureDefinition/PatientPseudonymisiert | *Version*:2027.0.0-ballot |
| Active Stand: 2026-09-01 | *Maschinenlesbarer Name*:MII_PR_Person_PatientPseudonymisiert |
...
Das pseudonymisierte Patientenprofil enthält ebenfalls die FHIR-Core-Extensions `patient-birthPlace`, `patient-citizenship` und `patient-nationality`, um Geburtsort, Staatsangehörigkeit und Nationalität dort abzubilden, wo sie in der pseudonymisierten Darstellung verfügbar sind.
