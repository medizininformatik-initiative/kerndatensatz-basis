# MII EXA Person Condition (Todesursache) - MII Implementation Guide Core Dataset Base v2027.0.0-ballot.rc1
...
Profile: [MII PR Person Todesursache](StructureDefinition-mii-pr-person-todesursache.md) version: 2027.0.0-ballot.rc1
...
```json
{
  ...
  "meta" : {
    ...
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/core/modul-person/StructureDefinition/Todesursache|2027.0.0-ballot.rc1"],
    "security" : [{
