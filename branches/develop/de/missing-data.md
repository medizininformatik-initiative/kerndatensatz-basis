# Umgang mit fehlenden Daten - MII Implementation Guide Core Dataset Base v2027.0.0-dev
...
Für allgemeine Hinweise zu Must Support Elementen siehe die Seite [Must Support](must-support.md). Für Konformitätserwartungen und Anforderungen an kodierte Elemente siehe die Seite [Allgemeine Anforderungen](general-requirements.md).

#### Elemente mit Mindest-Kardinalität = 0

**Regel**: Wenn das Quellsystem keine Daten für ein Element mit einer Mindest-Kardinalität = 0 hat (einschließlich Elemente, die als [Must Support](must-support.md) gekennzeichnet sind), **MUSS** das Datenelement aus der Ressource weggelassen werden.
...
1. **Wenn weder Text noch kodierte Daten vorhanden sind**:
...
1. **Wenn das ValueSet keinen entsprechenden "unknown" Konzeptcode hat**,**MÜSSEN**Sie ein Konzept aus dem ValueSet verwenden. Andernfalls ist die Instanz nicht konform.
