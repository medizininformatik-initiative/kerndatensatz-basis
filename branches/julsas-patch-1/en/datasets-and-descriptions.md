# Datasets and Descriptions - MII Implementation Guide Core Dataset Base v2027.0.0-ballot.rc1
...
For a complete list of all logical models, see the [Logical Models Overview](logical-models.md).
